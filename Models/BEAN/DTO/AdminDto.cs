namespace ShopQuanAo.Models.BEAN.DTO
{
    ...
    public class CreateProductWithSizesDto { public string ProductName { get; set; } = ""; public string? BrandName { get; set; } public double Price { get; set; } public string? Image { get; set; } public int CategoryId { get; set; } public List<SizeDto>? Sizes { get; set; } public string? Description { get; set; } }
